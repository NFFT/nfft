...
static inline void get_nm(const mxArray *prhs[], int *n, int *m)
{
  ...
  DM(if (t < 0)
	  mexPrintf("nfst: Input argument N must be non-negative.");)
  *n = t;
...
static inline void get_n1n2m(const mxArray *prhs[], int *n1, int *n2, int *m)
{
  ...
  DM(if (t < 0)
    mexPrintf("nfst: Input argument N1 must be non-negative.");)
  *n1 = t;

  t = nfft_mex_get_int(prhs[2],"nfst: Input argument N2 must be a scalar.");
  DM(if (t < 0)
	  mexPrintf("nfst: Input argument N2 must be non-negative.");)
  *n2 = t;
...
static inline void get_n1n2n3m(const mxArray *prhs[], int *n1, int *n2, int *n3, int *m)
{
  int t = nfft_mex_get_int(prhs[1],"nfst: Input argument N1 must be a scalar.");
  DM(if (t < 0)
    mexErrMsgTxt("nfst: Input argument N1 must be non-negative.");)
  *n1 = t;

  t = nfft_mex_get_int(prhs[2],"nfst: Input argument N2 must be a scalar.");
  DM(if (t < 0)
    mexErrMsgTxt("nfst: Input argument N2 must be non-negative.");)
  *n2 = t;

  t = nfft_mex_get_int(prhs[3],"nfst: Input argument N3 must be a scalar.");
  DM(if (t < 0)
    mexErrMsgTxt("nfst: Input argument N3 must be non-negative.");)
  *n3 = t;
