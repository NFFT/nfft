...
%   ndsft_trafo               - Discrete spherical Fourier transformation (direct algorithm)
...
%   nfsft_get_f_hat_linear    - Get Fourier coefficients from plan
%   nfsft_set_f_hat_linear    - Set Fourier coefficients in plan
