...
err_abs_max = norm(plan.f-f,Inf);               % Absolute ell_infinity error
err_rel_max = norm(plan.f-f,Inf)/norm(f,Inf);   % Relative ell_infinity error
err_abs_2 = norm(plan.f-f,2);                   % Absolute ell_2 error
err_rel_2 = norm(plan.f-f,2)/norm(f,2);         % Relative ell_2 error
