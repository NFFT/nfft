...
## 5. Generated coefficient tables
...
**log|sinc|** (`kernel/util/sinc.c`), behind the B-spline and sinc-power
...
The generators' own notes are in `tests/besselgen/README.md` and
