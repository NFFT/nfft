 ...
 *
 * Creates a random vector of fourier coefficients which is stored in omega.
...
void input()
{
	...
	// omega_policy
	printf("omega_policy (4: %s), (5: %s): ", omega_policy_descr[4],
				 omega_policy_descr[5]);
...
void process()
{
	...
	for (count = 0; count < testcases; count++) {
		...
		fprintf(omega_file,
						"# Generated by paper1/reconstruction/create_omega.\n");
