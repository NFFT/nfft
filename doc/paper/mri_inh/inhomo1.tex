...
Thus, no method is rising above the other in image quality.
...
advantages in image quality. The image in \ref{Fig:1} shows the result if the field inhomogenities are ignored (gridding).
