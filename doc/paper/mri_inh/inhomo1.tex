...
Thus, no method is rising above another in image quality.

\begin{table}[ht]
\begin{center}
\begin{tabular}{|l||c|c|c|c|c|} \hline
 \rule{0mm}{4mm} method $\backslash$ iter. & $1$ & $2$  & $5$  & $10$ &  \\[1ex] \hline\hline
 \multicolumn{5}{|c|}{\rule{0mm}{4mm} SNR}& Mem in MB\\[1ex] \hline\hline
 \rule{0mm}{4mm} 2d NFFT & 4.21 & 4.47 &  4.51 & 4.55 & 29 \\[1ex] \hline
 \rule{0mm}{4mm} 3d NNFFT & 10.15 & 13.60 & 14.13 & 14.56 & 599 \\[1ex] \hline
 \rule{0mm}{4mm} 3d NFFT & 10.15 & 13.60 & 14.13 & 14.56 & 189 \\[1ex] \hline
 \rule{0mm}{4mm} 2d$\otimes$1d NFFT & 10.15 & 13.60 & 14.13 & 14.56& 32\\[1ex] \hline \hline
 \multicolumn{5}{|c|}{\rule{0mm}{4mm} CPU-Time} & Time/Iter\\[1ex] \hline\hline
 \rule{0mm}{4mm} 2d NFFT & 5.07 & 7.61 & 15.24 & 27.95 & 2.54 \\[1ex] \hline
 \rule{0mm}{4mm} 3d NNFFT & 144.75 & 217.16 & 434.26 & 796.18& 72.41 \\[1ex] \hline
 \rule{0mm}{4mm} 3d NFFT & 84.55 & 126.68 & 253.20 & 464.14 & 42.13\\[1ex] \hline
 \rule{0mm}{4mm} 2d$\otimes$1d NFFT & 159.00 & 237.93 &  475.50 & 871.65 & 78.93\\[1ex] \hline
...
Now we compare the computation time and the memory consumption of the algorithms. In both categorys the 
3d NFFT beats the 3d NNFFT method. At first glance the 2d$\otimes$1d NFFT method is the slowest but with the lowest memory consumption. The 2d$\otimes$1d NFFT consumes almost the same memory as gridding. In Experiment \ref{Exp:2} we see the possibility to speed up the NFFT at expense of memory. Thus to choose the fastest method, the available memory must be considered.
\end{NumExp} 
...
independent form.
For better comparison we choose in example \ref{Exp:1} the same
flag PRE\_PSI for all reconstruction methods.
Table \ref{Tab:1} shows the CPU-time and memory consumtion of the 2d$\otimes$1d NFFT method with different flags.
The reconstruction object is the same as in example \ref{Exp:1}.
...
\begin{tabular}{|l||c|c|c|c|c|} \hline
 ...
 \rule{0mm}{4mm} no precompution &  &  &  &  &  \\[1ex] \hline
 \rule{0mm}{4mm} PRE\_LIN\_PSI & 288.47 & 432.04 & 862.95 & & 17 \\[1ex] \hline
...
\end{tabular}
\end{center}
\caption{CPU-time for different flags with the 2d$\otimes$1d NFFT reconstruction methods after $1$, $2$, $5$, and $10$ iterations.} \label{Tab:2}
\end{table}

If it is possible the flag PRE\_PSI is recommend. The advantage in Time is ...
The flag PRE\_FULL\_PSI gives another great speed up. Because this flag uses ... extra memory it can just be choosen if enough memory is available. 
