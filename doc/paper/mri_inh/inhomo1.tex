...
The NFFT2 library allows different flags to reduce computation time at expense of memory. Because the reconstruction algorithms have significantly different memory consumption  we tested different flags in experiment \ref{Exp:2}. 
...
\begin{tabular}{|l||c|c|c|c|c|} \hline
 ...
 \rule{0mm}{4mm} 2d NFFT & 4.21 & 4.47 &  4.51 & 4.55 & 31 \\[1ex] \hline
 \rule{0mm}{4mm} 3d NNFFT & 10.15 & 13.60 & 14.13 & 14.56 & 1394 \\[1ex] \hline
 \rule{0mm}{4mm} 3d NFFT & 10.15 & 13.60 & 14.13 & 14.56 & 256 \\[1ex] \hline
 \rule{0mm}{4mm} 2d$\otimes$1d NFFT & 10.12 & 13.53 & 14.01 & 14.41& 32\\[1ex] \hline \hline
 \multicolumn{5}{|c|}{\rule{0mm}{4mm} CPU-Time} & CPU-Time/Iter\\[1ex] \hline\hline
 \rule{0mm}{4mm} 2d NFFT &  &  &  &  &  \\[1ex] \hline
 \rule{0mm}{4mm} 3d NNFFT &  &  &  & &  \\[1ex] \hline \hline
 \rule{0mm}{4mm} 3d NFFT &  &  &  &  & \\[1ex] \hline
 \rule{0mm}{4mm} 2d$\otimes$1d NFFT &  &  &  &  & \\[1ex] \hline
...
independent form.
For better comparison we choose in experiment \ref{Exp:1} the same
...
The reconstruction object is the same as in experiment \ref{Exp:1}.
...
\begin{tabular}{|l||c|c|c|c|c|} \hline
 ...
 \rule{0mm}{4mm} PRE\_LIN\_PSI &  &  &  & &  \\[1ex] \hline
 \rule{0mm}{4mm} PRE\_PSI &  &  &  &  & \\[1ex] \hline
 \rule{0mm}{4mm} PRE\_FULL\_PSI &  &  &  &  & \\[1ex] \hline
\end{tabular}
\end{center}
...
The field map is shown in Figure \ref{Fig:fieldmap}. The off-resonance is in the interval $[-??,???]$ kHz, which 
