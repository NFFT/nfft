...
\end{tabular}
\end{center}
\caption{CPU-time for different flags with 2d$\otimes$1d NFFT reconstruction methods after $1$, $2$, $5$, and $10$ iterations.} \label{Tab:2}
\end{table}
