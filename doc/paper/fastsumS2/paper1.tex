...
%--------------------------------------------------------------------------
Beyond the well--known errors appearing in the NFFT computations, see  \cite{post02},
our algorithm produces the following error.
...
In contrast to results given in \cite{HuBa,CaFi}, we are interested also in
the decay of the symbol in relation to the parameter of the kernel.
We consider a couple of 'representative' kernels, where a closed form of the
kernel allows direct evaluation and some scheme for the precomputation of the
symbol is necessary for the fast summation algorithm.
...
\begin{figure}[tb]
  \centering
  \subfigure[$\sigma=$]
  XX%{\includegraphics[width=0.33\textwidth]{images/gauss1}}\hfill
  \subfigure[$\sigma=$]
  XX%{\includegraphics[width=0.33\textwidth]{images/gauss2}}\\
