...
\begin{figure}[ht]
  ...
  \begin{tabular}[h]{cc}
     ...
     \includegraphics[scale=0.4]{gauss1.eps}

     \includegraphics[scale=0.4]{gauss6.eps}
...
The software for this algorithm including all described tests is

available within the NFFT package

\cite[{\tt ./example/fastgauss}]{kupo02C}.

For the only available common example our algorithm is faster than those
