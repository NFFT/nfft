...
#define X(name) Y(name)
  ...
  CU_add_test(util, "bessel_i0_exp_scaled", X(check_bessel_i0_exp_scaled));
  CU_add_test(util, "bessel_i0_logtail", X(check_bessel_i0_logtail));
  ...
  CU_add_test(planner_suite, "md5_rfc_vectors",
              Y(check_planner_md5_rfc_vectors));
  ...
  CU_add_test(planner_suite, "wisdom_roundtrip",
  ...
  CU_add_test(planner_suite, "trinity_mkplan",
              Y(check_planner_trinity_mkplan));
  CU_add_test(planner_suite, "trinity_wisdom_memo",
              Y(check_planner_trinity_wisdom_memo));
  ...
  CU_add_test(planner_suite, "timelimit_default_and_set",
  ...
  CU_add_test(nplan_suite, "problem_owns_data",
              Y(check_nplan_problem_owns_data));
  CU_add_test(nplan_suite, "key_is_data_blind",
              Y(check_nplan_key_is_data_blind));
  CU_add_test(nplan_suite, "elides_unit_axes_geometry",
              Y(check_nplan_elides_unit_axes_geometry));
  ...
  CU_add_test(nplan_suite, "ndft_multivariate_dispatch",
              Y(check_nplan_ndft_multivariate_dispatch));
  ...
  CU_add_test(nplan_suite, "destructive_default",
              Y(check_nplan_destructive_default));
  ...
  CU_add_test(nplan_suite, "timelimit_tight_degrades_to_estimate",
              Y(check_nplan_timelimit_tight_degrades_to_estimate));
  CU_add_test(nplan_suite, "timelimit_unset_measures_and_blesses",
              Y(check_nplan_timelimit_unset_measures_and_blesses));
  CU_add_test(nplan_suite, "set_timelimit_roundtrip",
              Y(check_nplan_set_timelimit_roundtrip));
  CU_add_test(nplan_suite, "timelimit_partial_race_does_not_bless",
              Y(check_nplan_timelimit_partial_race_does_not_bless));
  CU_add_test(nplan_suite, "fftw_wisdom_only_declines",
              Y(check_nplan_fftw_wisdom_only_declines));
  CU_add_test(nplan_suite, "public_api", Y(check_nplan_public_api));
  CU_add_test(nplan_suite, "print_includes_registrar_names",
              Y(check_nplan_print_includes_registrar_names));
  CU_add_test(nplan_suite, "forward_only_race",
              Y(check_nplan_forward_only_race));
  CU_add_test(nplan_suite, "apply_adjoint", Y(check_nplan_apply_adjoint));
  CU_add_test(nplan_suite, "x_copied_not_aliased",
              Y(check_nplan_x_copied_not_aliased));
  CU_add_test(nplan_suite, "precompute_execute",
              Y(check_nplan_precompute_execute));
  CU_add_test(nplan_suite, "destroy_keeps_caller_arrays",
              Y(check_nplan_destroy_keeps_caller_arrays));
  CU_add_test(nplan_suite, "direct_only_bundle",
              Y(check_nplan_direct_only_bundle));
  ...
  CU_add_test(nplan_suite, "awake_zero_restore",
              Y(check_nplan_awake_zero_restore));
  CU_add_test(nplan_suite, "restore_guard_fires",
              Y(check_nplan_restore_guard_fires));
  CU_add_test(nplan_suite, "in_race_guard_passes",
              Y(check_nplan_in_race_guard_passes));
  CU_add_test(nplan_suite, "awake_zero_internal",
              Y(check_nplan_awake_zero_internal));
  CU_add_test(nplan_suite, "elides_unit_axes",
              Y(check_nplan_elides_unit_axes));
  CU_add_test(nplan_suite, "rank0_solver", Y(check_nplan_rank0_solver));
  CU_add_test(nplan_suite, "unit_axis_correct",
              Y(check_nplan_unit_axis_correct));
  CU_add_test(nplan_suite, "newarray_native_fast",
              Y(check_nplan_newarray_native_fast));
  CU_add_test(nplan_suite, "unit_axis_execute_on",
              Y(check_nplan_unit_axis_execute_on));
  CU_add_test(nplan_suite, "guru rejects NULL args",
  ...
  CU_add_test(nfast_suite, "window_normalized",
              Y(check_nfast_window_normalized));
  ...
  CU_add_test(nfast_suite, "deconv_1d_general",
              Y(check_nfast_deconv_1d_general));
  CU_add_test(nfast_suite, "deconv_2d_general",
              Y(check_nfast_deconv_2d_general));
  CU_add_test(nfast_suite, "deconv_3d_general",
              Y(check_nfast_deconv_3d_general));
  CU_add_test(nfast_suite, "deconv_nd_general",
              Y(check_nfast_deconv_nd_general));
  CU_add_test(nfast_suite, "conv_solver", Y(check_nfast_conv_solver));
  CU_add_test(nfast_suite, "native_fast_accuracy",
              Y(check_nfast_native_fast_accuracy));
  CU_add_test(nfast_suite, "native_tree", Y(check_nfast_native_tree));
  CU_add_test(nfast_suite, "native_declines_window",
              Y(check_nfast_native_declines_window));
  ...
  CU_add_test(nfast_suite, "native_fast_2d_adjoint",
              Y(check_nfast_native_fast_2d_adjoint));
  CU_add_test(nfast_suite, "native_fast_3d", Y(check_nfast_native_fast_3d));
  CU_add_test(nfast_suite, "native_fast_3d_adjoint",
              Y(check_nfast_native_fast_3d_adjoint));
  CU_add_test(nfast_suite, "native_fast_4d", Y(check_nfast_native_fast_4d));
  CU_add_test(nfast_suite, "native_fast_4d_adjoint",
              Y(check_nfast_native_fast_4d_adjoint));
  CU_add_test(nfast_suite, "float_accuracy", Y(check_nfast_float_accuracy));
  CU_add_test(nfast_suite, "window_cancellation",
              Y(check_nfast_window_cancellation));
  CU_add_test(nfast_suite, "window_apply", Y(check_nfast_window_apply));
  CU_add_test(nfast_suite, "native_window_select",
              Y(check_nfast_native_window_select));
