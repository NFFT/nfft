...
//  CU_add_test(nfft, "nfft_1d_file", X(check_1d_fast_file));
//  CU_add_test(nfft, "nfft_adjoint_1d_direct_file", X(check_adjoint_1d_direct_file));
//  CU_add_test(nfft, "nfft_adjoint_1d_file", X(check_adjoint_1d_fast_file));
...
#define X(name) NFCT(name)
  ...
  CU_add_test(nfct, "nfct_1d_file", X(check_1d_file));
  CU_add_test(nfct, "nfct_adjoint_1d_file", X(check_adjoint_1d_file));
//  CU_add_test(nfct, "nfct_1d_online", X(check_1d_online));
//  CU_add_test(nfct, "nfct_adjoint_1d_online", X(check_adjoint_1d_online));
  CU_add_test(nfct, "nfct_2d_file", X(check_2d_file));
  CU_add_test(nfct, "nfct_adjoint_2d_file", X(check_adjoint_2d_file));
//  CU_add_test(nfct, "nfct_2d_online", X(check_2d_online));
//  CU_add_test(nfct, "nfct_adjoint_2d_online", X(check_adjoint_2d_online));
//  CU_add_test(nfct, "nfct_3d_file", X(check_3d_file));
//  CU_add_test(nfct, "nfct_adjoint_3d_file", X(check_adjoint_3d_file));
