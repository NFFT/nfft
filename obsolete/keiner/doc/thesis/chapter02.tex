...
The concern of the \emph{discrete spherical Fourier transform} (DSFT) \index{Discrete spherical Fourier transform} 
...
\section{Discrete Spherical Fourier Transform and its Inversion}
