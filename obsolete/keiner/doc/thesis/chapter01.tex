...
\begin{figure}[tb]
  \centering
   \subfigure[$\lambda=1.0$]
     {\includegraphics[width=0.33\textwidth]{images/locsup1}}\hfill
   \subfigure[$\lambda=2.0$]
     {\includegraphics[width=0.33\textwidth]{images/locsup2}}
