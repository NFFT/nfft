...
$$
  \scalarproduct{K_{\V{\eta}}}{Y_{k}^n} = \int_{\twosphere} \fun{G}{\V{\eta} \cdot \V{\xi}} \overline{\fun{Y_{k}^n}{\V{\xi}}} \dx \V{\xi} = \fun{G^{\wedge}}{k} \overline{\fun{Y_{k}^n}{\V{\eta}}} \quad \paren{n=-k,\ldots,k},
$$
...
$$
and applying the Addition Theorem from Proposition \ref{Basics:AdditionTheorem}, we obtain for $G$ the orthogonal expansion
$$
  \fun{G}{x} = \sum_{k = 0}^{\infty} \frac{2n+1}{4\pi} \fun{G^{\wedge}}{k} \fun{P_k}{t} \quad \paren{x \in \interv{[}{-1}{1}{]}}.
$$
...
\begin{equation}
  \label{PoissonKernel}
  \nonumber
  \fun{Q_{h}}{t} := \frac{1}{4\pi} \frac{1-h^2}{\paren{1-2hx+h^2}^{3/2}} \quad \paren{x \in \interv{[}{-1}{1}{]}},
\end{equation}
