...
if(NFFT_WINDOW STREQUAL "kaiserbessel")
  ...
  set(WINDOW_NAME kaiserbessel)
elseif(NFFT_WINDOW STREQUAL "gaussian")
  set(GAUSSIAN ON)
  set(WINDOW_NAME gaussian)
elseif(NFFT_WINDOW STREQUAL "bspline")
  set(B_SPLINE ON)
  set(WINDOW_NAME bspline)
elseif(NFFT_WINDOW STREQUAL "sinc")
  set(SINC_POWER ON)
  set(WINDOW_NAME sinc)
elseif(NFFT_WINDOW STREQUAL "dirac" OR NFFT_WINDOW STREQUAL "delta")
  set(DIRAC_DELTA ON)
  set(WINDOW_NAME dirac)
else()
