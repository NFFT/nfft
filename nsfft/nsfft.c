...
void nsdft_trafo(sparse_nfft_plan *this)
{
  int j,k_S,k_L,k0,k1;
...
void nsdft_trafo_3d(sparse_nfft_plan_3d *this)
{
  int j,k_S,k0,k1,k2;
  double omega,cosx,sinx;
  int N=int_2_pow(this->J+2);
...
void nsfft_trafo(sparse_nfft_plan *this)
{
  int r,rr,j;
...
void nsfft_trafo_3d(sparse_nfft_plan_3d *this)
{
  int r,rr,j;
...
void nsfft_init(sparse_nfft_plan *this, int J, int M, int m, unsigned snfft_flags)
{
  int r;
  int N[2];
  int n[2];
...
/*========================================================*/
/* J >1, no precomputation at all!! */
void nsfft_init_3d(sparse_nfft_plan_3d *this, int J, int M, int m, unsigned snfft_flags)
{
  int r,rr,a,b;
  int N[3];
  int n[3];
...
void nsfft_finalize(sparse_nfft_plan *this)
{
  int r;
...
void nsfft_finalize_3d(sparse_nfft_plan_3d *this)
{
  int r;
