...
\
  ...
  C *g2; /**< Output of fftw */\
\
  R *spline_coeffs; /**< Polynomial window, NULL with ANALYTIC_WINDOW */\
\
...
/* The window from its closed form, not the polynomial fitted at plan time.
 * Orthogonal to PRE_ONE_PSI. Kaiser-Bessel and sinc-power have a polynomial
 * form; the other windows ignore the flag. */
