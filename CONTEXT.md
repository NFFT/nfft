...
This glossary fixes the vocabulary for the **dual build system** (Autotools +
CMake) and the **CodSpeed benchmark CI** work, where several terms are easy to
confuse. See [ADR-0001](docs/adr/0001-adopt-cmake-alongside-autotools.md).
