...
*[← Overview & map](../REFERENCE.md) — cross-cutting reference; applies to Phases A, D, E.*
...
- **Phase D** — after every kept change, run the **B-net** in all three (`checkall` per tree,
...
- **Phase E** — re-run the ENTIRE baseline (full `ctest` + ALL benchmark cases) in all three;
